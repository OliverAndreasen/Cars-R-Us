...
public class MemberController {
  ...
  @PutMapping("/{username}")
  public ResponseEntity<Boolean> editMember(
  ...
  ***********/
  ...
  public MemberResponse getMemberById(@PathVariable String username)
    throws Exception { //Obviously we need to be able to limit this in a system with thousands of members
