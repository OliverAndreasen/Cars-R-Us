...
public class SetupDevUsers implements ApplicationRunner {
  ...
  public void run(ApplicationArguments args) {
    ...
    Member m2 = new Member("member2", passwordUsedByAll, "memb2@a.dk", "Jacob", "Henriksen", "Kongevej 2", "Lynbby", "2800");
    Member m3 = new Member("member3", passwordUsedByAll, "memb3@a.dk", "Søren", "Sæl", "Struensegade 2", "København", "2200");
